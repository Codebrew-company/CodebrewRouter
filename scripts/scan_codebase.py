...
# Accept directory via CLI arg or CODEBREW_DIR env var; default to repo root (parent of scripts/)
CODEBREW_DIR = sys.argv[1] if len(sys.argv) > 1 else os.environ.get(
    "CODEBREW_DIR", os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
parts.append(f"Located at {CODEBREW_DIR} (Blaze.LlmGateway .NET 10 solution)")
parts.append("")
