namespace Blaze.LlmGateway.Api.Models;
...
/// <summary>
/// Request body for the /api/chat backward-compatibility endpoint.
/// Mirrors OpenAI-compatible chat request shape.
/// </summary>
...
/// <summary>
/// Request body for POST /api/memory — adding a new memory entry.
/// </summary>
public class AddMemoryPayload
{
    public string Content { get; set; } = string.Empty;
    public Dictionary<string, string>? Metadata { get; set; }
}
